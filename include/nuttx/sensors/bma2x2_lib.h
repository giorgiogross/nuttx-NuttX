...
#ifndef __INCLUDE_NUTTX_SENSORS_BMA2X2_H
#define __INCLUDE_NUTTX_SENSORS_BMA2X2_H
...
*/
#define BMA2x2_BUS_WRITE_FUNC(dev_addr, reg_addr, reg_data, wr_len)\
bus_write(p_bma2x2->priv, dev_addr, reg_addr, reg_data, wr_len)
...
bus_read(p_bma2x2->priv, dev_addr, reg_addr, reg_data, r_len)
#define BMA2x2_BURST_READ_FUNC(device_addr,\
register_addr, register_data, rd_len)\
burst_read(p_bma2x2->priv, device_addr, register_addr, register_data, rd_len)
/**************************************************************/
 ...
 *  Priv pointer to concrete implementation for sensor of this bosch series
 */
struct bma2x2_t {
	...
	/* device-specific resolution for xyz data, one of BMA2x2_14_RESOLUTION,
	   BMA2x2_10_RESOLUTION, BMA2x2_12_RESOLUTION */
  u8 resolution;

	/* priv of associated device. Set this field to your priv created in your register()
	 * function of the device specific nuttx driver */
	void* priv;
};
 ...
 *
 *
 *  @param  accel_z_s8 : the data of z
 *
 *
 *	@return results of bus communication function
 *	@retval 0 -> Success
